// Build Challenge data for website-only CS202 mini-project practice.
(function () {
  ...
  "assumptions": [
    "Build Challenges are mini-project practice. You are practicing design, not just one missing line.",
    "The website does not compile your code. Write a plan, sketch your Java, then compare with the official build review.",
    "Prefer clear CS202 code: fields, constructors, methods, loops, arrays/ArrayLists, and simple class relationships."
  ],
  "base": [
    {
      "id": "BCB001",
      ...
      "deliverables": [
        "Identify the classes or methods needed.",
        "Write a small but complete CS202-level solution.",
        "Explain one test case that proves the build works."
      ],
      "milestones": [
        "Read the goal and underline the nouns and verbs.",
        "Decide which variables, fields, or methods are needed.",
        "Write the smallest working version before adding extras."
      ],
      "hints": [
        "Start by writing the method headers or class fields first.",
        "Test one normal case and one boundary case."
      ],
      "modelPlan": "Break the build into state, behavior, and test cases. Start with headers/fields, then fill in method bodies.",
    ...
    "level3": [
      {
        ...
        "deliverables": [
          "Choose the class/method structure without walkthrough help.",
          "Write a complete CS202-level solution sketch.",
          "Name at least one test case or edge case."
        ],
        "milestones": [],
        "hints": [],
        "modelPlan": "Break the build into state, behavior, and test cases. Start with headers/fields, then fill in method bodies.",
